class UserController {
    ...
    onEdit (tr) {
        ...
        const userId = JSON.parse(tr.dataset.userLevel)._id
        ...
        this.formUpdateEl.onsubmit = e => {
            ...
            }).catch(error => console.error(error)).finally(() => btnSubmit.disabled = false)
    ...
    templateTable (tr, dataUser) {
            ...
            tr.innerHTML = `
                ...
                <td>${Utils.formatData(new Date(dataUser.register || dataUser._register || new Date()))}</td>
                <td>
